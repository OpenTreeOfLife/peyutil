...
project = "peyutil"
copyright = "2020-{}, Open Tree of Life developers".format(time.strftime("%Y"))
...
latex_documents = [
    (
        "index",
        "peyutil.tex",
        "peyutil Documentation",
        "Open Tree of Life developers",
        "manual",
    ),
]
...
epub_title = "peyutil"
epub_author = "Open Tree of Life developers"
epub_publisher = epub_author
epub_copyright = "2020, {}".format(epub_author)
